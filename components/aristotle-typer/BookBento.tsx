        ...
        <div className="shadow-xl rounded-lg mb-16 p-4 bg-[var(--primary-bg-color)] lg: mx-0 mx-4">  
            <div key={bookNumber} className="lg:grid lg:grid-cols-4 lg:grid-rows-4 gap-4 rounded-lg p-4">
                ...
                <div className="lg:col-span-3 lg:row-span-3 bg-[var(--dark-bg-color)] border border-stone-600 rounded-xl px-8 py-8 flex flex-wrap">
                    <h2 className={`font-libre-baskerville font-bold lg:text-5xl text-2xl text-sky-50`}>Book {bookNumber}</h2>
                    <p className={`font-libre-baskerville lg:text-lg text-sm text-sky-50 pt-16 self-end`}>{description}</p>
                </div>
                ...
                <div className={`lg:col-span-1 lg:row-span-1 bg-gray-500 font-libre-baskerville text-sky-50 text-center text-md rounded-full content-center p-2 mt-4`}>
                ...
                <div className={`lg:col-span-1 lg:row-span-1 ${selectedSection > 0 ? 'bg-[var(--accent-bg-color)]' : 'bg-gray-400'} font-libre-baskerville font-bold text-sky-50 text-center text-lg rounded-full content-center p-4 mt-4`}>
